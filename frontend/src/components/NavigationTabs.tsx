import {
  ...
  BuildingLibraryIcon,
  MapPinIcon,
  // 1. Importa los iconos que usaremos para "Eventos"
  CalendarDaysIcon,
  SparklesIcon,
} from "@heroicons/react/20/solid";
import { Link, useLocation, useNavigate } from "react-router-dom";

// 2. Añade el nuevo objeto "Eventos" al array
const tabs = [
                            ...
                            <Link
                              ...
                              className={classNames(
                                location.pathname === child.href
                                  ? "border-[#66ccff] text-[#66ccff]"
                                  : "border-transparent text-gray-500 hover:text-gray-700",
                                "group inline-flex items-center py-2 px-4 text-xl font-medium w-full text-left"
                              )}
                            >
                              <child.icon
                                className={classNames(
